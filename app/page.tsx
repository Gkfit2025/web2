    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <header className="bg-orange-900 text-white py-5 text-center sticky top-0 z-50">
        <div className="flex items-center justify-center gap-4 mb-2">
          ...
          <div>
            ...
            <p className="text-orange-100 mt-1">Healing Lives, Transforming Communities</p>
          </div>
          {/* QR Code added here */}
          <div className="ml-4">
            <Image
      ...
      <section id="about" className="py-12 md:py-16 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-orange-900 mb-8">About Grace Kennett Foundation</h2>
      ...
      <section id="hospital" className="py-12 md:py-16 px-4 text-center bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-orange-900 mb-12">Hospital Services</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="hover:shadow-lg transition-shadow duration-300 hover:-translate-y-1">
              <CardHeader className="text-center">
                <Heart className="w-12 h-12 text-red-500 mx-auto mb-4" />
                <CardTitle className="text-orange-600">General Medicine</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="hover:shadow-lg transition-shadow duration-300 hover:-translate-y-1">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-orange-600">Burns Treatment</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="hover:shadow-lg transition-shadow duration-300 hover:-translate-y-1">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-orange-600">Pediatric Care</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="hover:shadow-lg transition-shadow duration-300 hover:-translate-y-1">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-orange-600">Community Health</CardTitle>
              </CardHeader>
              <CardContent>
      ...
      <section id="doctors" className="py-12 md:py-16 px-4 text-center">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-orange-900 mb-12">Our Doctors</h2>
      ...
      {/* Contact Section */}
      <section id="contact" className="py-12 md:py-16 px-4 text-center bg-orange-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-orange-900 mb-8">Contact Us</h2>
