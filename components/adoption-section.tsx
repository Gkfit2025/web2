  ...
  return (
    <section id="adoption" className="py-12 md:py-16 px-4 text-center">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-blue-900 mb-12">Adoption Services</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="hover:shadow-lg transition-shadow duration-300">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-blue-600">Child Care</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="hover:shadow-lg transition-shadow duration-300">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-blue-600">Family Matching</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="hover:shadow-lg transition-shadow duration-300">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-blue-600">Counseling</CardTitle>
            </CardHeader>
            <CardContent>
